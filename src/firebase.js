...
import { getFirestore, collection, onSnapshot } from 'firebase/firestore'; // Modular imports
...
export { app, auth, firestore, storage, messaging, getToken, onMessage, collection, onSnapshot };
